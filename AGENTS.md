...
- **One paragraph per line.** Do not hard-wrap paragraphs at 80 (or any) characters. Each paragraph is a single line; let the editor soft-wrap it. This applies to all Markdown content under `content/` (posts, projects, tips, and pages).
